  ...
  return (
    <header className="h-16 bg-white border-b border-slate-100 flex items-center px-6 gap-4 shrink-0">
      ...
      <div className="flex items-center gap-2">
        <SelectFake label="光明中学" />
        <SelectFake label="初二 (3) 班" />
        <SelectFake label="数学" />
      </div>

      <div className="flex-1 max-w-[420px] ml-4">
...
function SelectFake({ label }) {
  return (
    <button className="h-9 px-3 rounded-lg border border-slate-200 bg-white text-sm text-slate-600 flex items-center gap-2 hover:border-brand-300">
      {label}
